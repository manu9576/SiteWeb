...
<div class="ahc_main_container">
   ...
   <h1>&nbsp;&nbsp;Visitors Traffic Real Time Statistics <span style="font-size:15px; color:#900 ">&nbsp;</span></h1>
   <br />
   
   <!-- end languages links -->
   <p style="float:right"><i><a title="Preview & Pricing" target="_blank"  href="http://www.wp-buy.com/product/visitors-traffic-real-time-statistics-pro"><strong style="color:#F00">Upgrade</strong> to premium version and get the data you need to make intelligent marketing</a></i></p>
   <div class="row">
      <div class="col-md-12">
         <div class="panel" >
